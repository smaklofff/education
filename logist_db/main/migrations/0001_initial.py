...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('options', models.CharField(max_length=50, unique=True, verbose_name='Вариант оплаты')),
            ],
        ),
        migrations.CreateModel(
            name='Regularity',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('regularity', models.CharField(max_length=50, unique=True, verbose_name='Регулярность')),
            ],
        ),
        migrations.CreateModel(
            name='Users',
            fields=[
                ...
                ('password', models.CharField(max_length=100, verbose_name='Логин')),
            ],
        ),
        migrations.CreateModel(
            name='Transactions',
